...
| `src/Notices/` | `Queue` (what a notice says, who may consume it), `Store` (keeps it), `Renderer` (draws it). |
...
- Options: `{$hook_prefix}_plugin_absorber_activations`, `{$hook_prefix}_plugin_absorber_notices`
